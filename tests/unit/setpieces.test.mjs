...
test('skill move and lob exist as actions, counters fire, tuning knobs are the defaults', () => {
  ...
  try {
    ...
    void sp;
    assert.deepEqual(TUNE, { drop: 2, squeeze: 0.93, counter: true, sweeper: true, runs: true, keeperDist: true, shotRate: 0.7, tackleRate: 0.6, boxCare: 0.35, support: true, advantage: true });
  } finally { Math.random = realRandom; }
});
