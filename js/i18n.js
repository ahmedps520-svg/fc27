...
const AR = {
  ...
  'squad.title': 'التشكيلة المثالية', 'nav.club': 'النادي', 'nav.division': 'الدرجة', 'nav.online': 'أونلاين', 'nav.objectives': 'الأهداف', 'nav.challenges': 'التحديات', 'nav.store': 'المتجر',
...
const EN = {
  ...
  'squad.title': 'Ultimate XI', 'nav.club': 'Club', 'nav.division': 'Division', 'nav.online': 'Online', 'nav.objectives': 'Objectives', 'nav.challenges': 'Challenges', 'nav.store': 'Store',
