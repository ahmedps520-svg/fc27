...
export const PACK_US = {
  ...
  pbp: {
    ...
    red: ['Red card! He\'s off!', 'He\'s been sent off!', 'Straight red!', 'Second yellow, and off he goes!', 'Down to ten men!'],
  ...
  co: {
    ...
    red: ['That changes the whole game.', 'You simply can\'t make that challenge.', 'Now they\'ve got a real problem.'],
