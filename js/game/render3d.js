...
/* ---------------------------- quality ------------------------------ */
// v87: the quality picker lives in quality.js so the menu can use it without pulling the renderer in
export { deviceClass, resolveQuality, classifyGPU } from './quality.js';
